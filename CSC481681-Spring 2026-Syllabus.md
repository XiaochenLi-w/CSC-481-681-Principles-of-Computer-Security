...
# CSC 481/681/781 - Spring 2026 - Syllabus
...
**Catalog Description:** Core concepts in computer security, including the security goals of confidentiality, integrity, and availability; authentication; access control; use of cryptography; secure software development; and basic network security.
...
3. Identify appropriate technologies related to different computer security goals;
4. Describe high-level properties of basic cryptographic mechanisms, including symmetric and public-key encryption, pseudorandom number generators, cryptographic hash functions, and digital signatures;
5. Explain secure design principles such as isolation and least privilege, and their relation to modern system tools and technologies;
6. Identify common vulnerabilities in software;
7. Describe secure software development principles and practices;
8. Diagram a basic networked system, identifying security-sensitive aspects and appropriate protection techniques;
9. (Graduate Students) Explain and critique research in computer security.
 ...
 **Hands-on Exercises and Optional Text:** The hands-on exercises in this course are based on Wenliang Du’s SEED Labs. Detailed instructions are available on the SEED website (https://seedsecuritylabs.org/) for students to follow. Students are expected to submit lab reports for grading. Those interested in learning more may also consider purchasing Professor Du’s book for additional insights.

Wenliang Du. *Computer Security: A Hands-on Approach*, CreateSpace Independent Publishing, 2017. ISBN-13: 978-1548367947.

**Topics:** The topics to be covered are shown below. For an updated week-by-week schedule, please see the class web site.
...
> Cryptography for information protection (Section 1.3, Sections 8.1–8.4, and handouts) [8 classes]

> Physical security (Sections 2.1-2.5) [1 class]

> Practical Operating System and Linux Overview (readings) [1 class]

> Operating System Security - Basics (Sections 3.1-3.3) [1 class]

> Operating System Security - Advanced: sandboxes, chroot, and containers (readings) [1 class]
...
*Assignments and SEEDLABS Requirements:* For practice and to demonstrate abilities, students will be given 5 or 6 assignments over the course of the semester (approximately every two weeks, adjusted to exclude exam weeks). Assignments can include written problems or hands-on SEEDLABS exercises. The SEED Labs used in this course come with detailed setup requirements provided on the [SEED website](https://seedsecuritylabs.org/labsetup.html). All hands-on exercises will be completed inside a virtual machine (VM) environment. For students using Apple systems with an “Apple Silicon” CPU, the SEED platform also provides recommended solutions and workarounds.

If, for any reason, you are unable to run the SEED Lab exercises as required, alternative arrangements may be possible. However, you must contact the instructor as early as possible—ideally *before* the first assignment is released.

All work will be submitted in Canvas. Student-written homework solutions must be PDF documents, but can be either electronically prepared or neatly handwritten and scanned. If you must use a phone camera rather than a scanner, you should use a “scan to PDF” app to produce a proper and readable PDF document. All hands-on exercises must be submitted in the form of a written lab report in PDF format for grading. *I will grade what is submitted, and you are responsible for submitting with enough time to check and make sure you successfully submitted the right thing. “I submitted the wrong file” or “the file was corrupted” or “Canvas was slow at 11:58” will not be accepted as excuses for late submissions.*

*Exams:* There will be one mid-term exam and one final exam, which will assess the student’s mastery of learning outcomes 1-7 in an exam setting. Problems will be similar to the written homework problems as well as the in-class exercises, but will be somewhat simplified compared to the homework assignments due to the time limitations of testing. Note that exams will be given in a standard controlled environment, and no one may leave the room during the exam for any reason. If you cannot sit for up to 90 minutes for an exam, you should see the OARS office for accommodations and an alternative exam location.
...
**Evaluation and Grading:** Each student's work product will be graded, and the student’s final grade will be determined by assigning each category of work a weighted score according to the distribution below, and then the final weighted average is mapped to a letter grade as shown. Note that students have access to their current class average at all times in Canvas.
...
**In-class Behavior:** When you are in class you should be focused on the class, and you should act in a professional and mature manner. During class, there should be no eating, drinking, e-cigarette use, cellphone use, non-class-related laptop use, or anything else that does not pertain to the class activities. Any distracting items may be confiscated at the discretion of the instructor. Significant violations or disruptive behavior will result in points subtracted from a student’s final grade, and possible reporting to the UNCG [Office of Student Rights and Responsibilities](https://osrr.uncg.edu/).
